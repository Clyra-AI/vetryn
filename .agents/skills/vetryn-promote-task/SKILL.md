...
2. Require one exact candidate commit, successful candidate-bound evidence for every passing criterion and gate, all required reviews approved by independent roles, no blockers, no stale digests, and no non-waivable gap. Stop rather than manufacturing or inferring evidence.
