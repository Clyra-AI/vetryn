...
2. Require one exact candidate commit, gate-bound command evidence for every passing command criterion and gate, all required reviews authenticated live against GitHub and protected-main CODEOWNERS, no blockers, no stale digests, and no non-waivable gap. Stop rather than manufacturing or inferring evidence.
