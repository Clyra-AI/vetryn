...
5. Validate that evidence is candidate-bound, successful, compact, and redacted. A summary, snapshot, or LLM judgment does not replace the declared deterministic assertion.
