...
validates usage accounting before reporting success, refuses stale source fingerprints without a patch, emits
redacted mock events, and has no network or credential behavior.
