...
project maintainers by opening a [private report](https://github.com/Clyra-AI/vetryn/security/advisories/new).
Reports will be handled confidentially. If the report concerns a maintainer, that person will be
excluded from handling it.
